...
using JazzFaxGatewayStatus.FaxGateway;
using JazzFaxGatewayStatus.RightFax;
using RFCOMAPILib;
using System.IO;
using System.Linq;

namespace JazzFaxGatewayStatus
{
    internal class Program
    {
        private static void Main()
        {
            ...
            var faxStatus = new StatusDto[recCount];
            using (var faxServiceClient = new FaxServiceClient())
            {
